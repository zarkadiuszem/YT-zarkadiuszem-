...
INSERT INTO library (libraryID, street, house_number, city, zip_code, phone_number) VALUES
('Filia01','Dobra', '23', 'Warszawa', '01-001', '00223344'),
('Filia02','Dzielna', '11', 'Szczecin', '71-444', '80253354'),
('Filia03','Miła', '21/3', 'Katowice', '41-102', '33236314');

INSERT INTO employee (libraryID, first_name, last_name, street, house_number, city, zip_code, phone_number) VALUES
('Filia01', 'Tomek', 'Kusy', 'Majowa', '21', 'Warszawa', '01-222', '23443222'),
('Filia01', 'Jarosław', 'Kowalski', 'Polna', '34', 'Warszawa', '01-432', '33443242'),
('Filia02', 'Malwina', 'Górecka', 'Klonowa', 'Szczecin', '77', '70-242', '19943222'),
('Filia03', 'Roksana', 'Bogacka', 'Miodowa', 'Katowice', '61', '41-923', '89674322');

# uzupełniamy tabelę borrowing (uwaga - przestawione kolumny, 120 wypożyczeń)

INSERT INTO borrowing (membersID, booksID, borrowing_date, return_date, comments, employeeID) VALUES
(1, 1, '2024-03-02', '2024-04-09', NULL, 1),
(2, 2, '2024-03-02', '2024-04-08', NULL, 1),
(3, 3, '2024-03-03', '2024-04-10', NULL, 1),
(4, 4, '2024-03-11', '2024-03-11', 'Książka zniszczona', 1),
(5, 5, '2024-03-04', NULL, NULL, 1),
(6, 6, '2024-03-04', NULL, NULL, 1),
(7, 7, '2024-03-05', NULL, NULL, 1),
(8, 8, '2024-03-05', '2024-03-11', NULL, 1),
(9, 4, '2024-04-01', '2024-04-06', 'Książka z uszkodzoną okładką', 1),
(10, 8, '2024-04-06', '2024-04-12', NULL, 1),
(11, 11, '2024-04-07', '2024-04-14', NULL, 1),
(12, 12, '2024-04-07', '2024-04-13', NULL, 1),
(13, 13, '2024-04-08', '2024-04-15', NULL, 1),
(14, 14, '2024-04-08', '2024-04-14', NULL, 1),
(15, 15, '2024-04-09', '2024-04-16', 'Książka z odręcznymi notatkami', 1),
(16, 16, '2024-04-09', '2024-04-15', NULL, 1),
(17, 17, '2024-04-10', '2024-04-17', NULL, 1),
(18, 18, '2024-04-10', '2024-04-16', NULL, 1),
(19, 19, '2024-04-11', '2024-04-18', NULL, 1),
(20, 20, '2024-04-11', '2024-04-17', NULL, 1),
(21, 21, '2024-04-02', '2024-04-09', NULL, 1),
(22, 22, '2024-04-02', '2024-04-08', NULL, 1),
(23, 23, '2024-04-03', '2024-04-10', NULL, 1),
(4, 24, '2024-04-03', '2024-04-09', NULL, 2),
(25, 25, '2024-04-04', '2024-04-11', NULL, 1),
(26, 26, '2024-04-04', '2024-04-10', NULL, 1),
(27, 27, '2024-04-05', '2024-04-12', NULL, 1),
(28, 28, '2024-04-05', '2024-04-11', 'Wypożyczający pytał o kolejne części', 1),
(29, 29, '2024-04-06', '2024-04-13', NULL, 1),
(30, 30, '2024-04-06', '2024-04-12', NULL, 1),
(31, 31, '2024-04-07', '2024-04-14', NULL, 1),
(32, 32, '2024-04-07', '2024-04-13', NULL, 1),
(33, 33, '2024-04-08', '2024-04-15', NULL, 1),
(34, 4, '2024-04-08', '2024-04-10', NULL, 1),
(35, 35, '2024-04-09', '2024-04-16', 'Wypożyczający pytał o inne książki tego autora', 2),
(36, 36, '2024-04-09', '2024-04-15', NULL, 2),
(37, 37, '2024-04-10', '2024-04-17', NULL, 2),
(38, 38, '2024-04-10', '2024-04-16', NULL, 2),
(39, 39, '2024-04-11', '2024-04-18', NULL, 2),
(40, 40, '2024-04-11', '2024-04-17', NULL, 2),
(21, 111, '2024-04-02', '2024-04-09', NULL, 2),
(22, 112, '2024-04-02', '2024-04-08', 'Wypożyczający pytał o inne książki tego autora', 2),
(23, 113, '2024-04-03', '2024-04-10', NULL, 2),
(24, 114, '2024-04-03', '2024-04-09', NULL, 2),
(25, 115, '2024-04-04', '2024-04-11', NULL, 2),
(26, 116, '2024-04-04', '2024-04-10', NULL, 2),
(27, 117, '2024-04-05', '2024-04-12', NULL, 2),
(28, 118, '2024-04-05', '2024-04-11', 'Książka ma zniszczoną okładkę', 2),
(29, 119, '2024-04-06', '2024-04-13', NULL, 2),
(30, 110, '2024-04-06', '2024-04-12', NULL, 2),
(31, 120, '2024-04-07', '2024-04-14', NULL, 2),
(32, 121, '2024-04-07', '2024-04-13', NULL, 2),
(33, 131, '2024-04-08', NULL, NULL, 2),
(34, 141, '2024-04-08', '2024-04-14', NULL, 2),
(35, 151, '2024-04-09', NULL, NULL, 3),
(36, 161, '2024-04-09', '2024-04-15', NULL, 3),
(37, 171, '2024-04-10', '2024-04-17', NULL, 3),
(38, 181, '2024-04-10', '2024-04-16', NULL, 3),
(39, 191, '2024-04-11', '2024-04-18', NULL, 3),
(40, 201, '2024-04-11', '2024-04-17', NULL, 3),
(21, 4, '2024-04-11', NULL , NULL, 3),
(22, 41, '2024-04-02', '2024-04-08', NULL, 3),
(23, 42, '2024-04-03', '2024-04-10', NULL, 3),
(24, 43, '2024-04-03', '2024-04-09', NULL, 3),
(25, 44, '2024-04-04', '2024-04-11', NULL, 3),
(26, 45, '2024-04-04', '2024-04-10', NULL, 3),
(27, 46, '2024-04-05', '2024-04-12', NULL, 3),
(28, 47, '2024-04-05', '2024-04-11', NULL, 3),
(29, 48, '2024-04-06', '2024-04-13', NULL, 3),
(30, 49, '2024-04-06', '2024-04-12', NULL, 3),
(31, 50, '2024-04-07', NULL, NULL, 3),
(32, 51, '2024-04-07', NULL, NULL, 3),
(33, 52, '2024-04-08', '2024-04-15', NULL, 3),
(34, 53, '2024-04-08', '2024-04-14', NULL, 3),
(35, 54, '2024-04-09', '2024-04-16', NULL, 3),
(36, 55, '2024-04-09', '2024-04-15', NULL, 3),
(37, 56, '2024-04-10', '2024-04-17', NULL, 3),
(38, 57, '2024-04-10', '2024-04-16', NULL, 3),
(39, 58, '2024-04-11', '2024-04-18', NULL, 3),
(40, 59, '2024-04-11', '2024-04-17', NULL, 3),
(21, 60, '2024-04-02', '2024-04-09', NULL, 3),
(22, 61, '2024-04-02', '2024-04-08', NULL, 3),
(23, 62, '2024-04-03', '2024-04-10', NULL, 3),
(24, 63, '2024-04-03', '2024-04-09', NULL, 3),
(25, 64, '2024-04-04', '2024-04-11', NULL, 3),
(26, 65, '2024-04-04', '2024-04-10', NULL, 3),
(27, 66, '2024-04-05', '2024-04-12', NULL, 3),
(28, 67, '2024-04-05', '2024-04-11', NULL, 3),
(29, 68, '2024-04-06', '2024-04-13', NULL, 3),
(30, 69, '2024-04-06', '2024-04-12', NULL, 3),
(31, 70, '2024-04-07', '2024-04-14', NULL, 3),
(32, 71, '2024-04-07', '2024-04-13', NULL, 3),
(33, 72, '2024-04-08', '2024-04-15', NULL, 3),
(34, 73, '2024-04-08', '2024-04-14', NULL, 3),
(35, 74, '2024-04-09', NULL, NULL, 3),
(36, 75, '2024-04-09', '2024-04-15', NULL, 3),
(37, 76, '2024-04-10', '2024-04-17', NULL, 3),
(38, 77, '2024-04-10', '2024-04-16', NULL, 3),
(39, 78, '2024-04-11', '2024-04-18', NULL, 3),
(40, 79, '2024-04-11', '2024-04-17', NULL, 3),
(21, 80, '2024-04-02', '2024-04-09', NULL, 3),
(22, 81, '2024-04-02', '2024-04-08', NULL, 3),
(23, 82, '2024-04-03', '2024-04-10', NULL, 3),
(24, 83, '2024-04-03', '2024-04-09', NULL, 3),
(25, 84, '2024-04-04', '2024-04-11', NULL, 3),
(26, 85, '2024-04-04', '2024-04-10', NULL, 3),
(27, 86, '2024-04-05', '2024-04-12', NULL, 3),
(4, 87, '2024-04-05', '2024-04-11', NULL, 3),
(29, 88, '2024-04-06', '2024-04-13', NULL, 3),
(30, 89, '2024-04-06', '2024-04-12', NULL, 3),
(31, 90, '2024-04-07', '2024-04-14', NULL, 3),
(32, 91, '2024-04-07', '2024-04-13', NULL, 3),
(33, 92, '2024-04-08', '2024-04-15', NULL, 3),
(34, 93, '2024-04-08', '2024-04-14', NULL, 4),
(35, 94, '2024-04-09', '2024-04-16', NULL, 4),
(36, 95, '2024-04-09', '2024-04-15', NULL, 4),
(37, 96, '2024-04-10', NULL, NULL, 4),
(38, 97, '2024-04-10', '2024-04-16', NULL, 4),
(39, 98, '2024-04-11', '2024-04-18', NULL, 4),
(40, 99, '2024-04-11', '2024-04-17', NULL, 4);

-- Zapytania część 4 
# dwa egzemplarze książki zostały wypożyczone więcej niż raz (ID 4 i 8)
# uporządkowane dane (daty wypożyczeń tej samej książki nie nakładają się na siebie)

# ZADANIE: Łączymy wszystkie tabele
-- pierwsza tabela
...
-- dodajemy employeeID (numer pracownika biblioteki)
SELECT 
   b.booksID, b.title, bor.borrowing_date, bor.return_date, bor.employeeID
FROM
    borrowing bor
        LEFT JOIN
    books b ON bor.booksID = b.booksID
...
-- dodajemy trzecią tabelę employee
SELECT 
    b.booksID,
    b.title,
    bor.borrowing_date,
...
FROM
    ...
    books b ON bor.booksID = b.booksID
        LEFT JOIN
    employee e ON bor.employeeID = e.employeeID
ORDER BY b.booksID;


-- dodajemy czwartą tabelę library
SELECT 
    b.booksID,
    b.title,
    bor.borrowing_date,
...
FROM
    ...
    employee e ON bor.employeeID = e.employeeID
        LEFT JOIN
    library l ON e.libraryID = l.libraryID;
    
-- Dodajemy piątą tabelę members
SELECT 
    b.booksID,
    b.title,
    bor.borrowing_date,
...
-- dodajemy aliasy 
    ...
    l.libraryID,
    m.first_name AS 'imię czytelnika',
    m.last_name AS 'nazwisko czytelnika'
FROM
    borrowing bor
        LEFT JOIN
    books b ON bor.booksID = b.booksID
...
## aggregate functions (wybrane funkcje statystyczne)
--  COUNT
SELECT 
    COUNT(employeeID)
FROM
...
FROM
    ...
    -- ile jest unikalnych tytułów 
SELECT 
    COUNT(DISTINCT title)
FROM
    books;
    
	-- czy tytuły rzeczywiście się powtarzają? 
SELECT 
    title
FROM
    books
...
SELECT 
    publishing_house, COUNT(publishing_house)
FROM
    books
GROUP BY publishing_house;

-- inaczej to samo zestawienie
SELECT 
    publishing_house, COUNT(*)
FROM
    books
GROUP BY publishing_house;

-- dodajemy drugą zmienną
SELECT 
    publishing_house, hard_cover, COUNT(*)
FROM
    books
GROUP BY publishing_house , hard_cover
ORDER BY publishing_house , hard_cover;

SELECT 
    publishing_house, COUNT(publishing_house) AS częstość
FROM
    books
GROUP BY publishing_house
ORDER BY częstość DESC;
...
SELECT 
    AVG(number_of_pages), SUM(number_of_pages)
FROM
    books;
    
SELECT 
    hard_cover, AVG(number_of_pages), SUM(number_of_pages)
FROM
    books
GROUP BY hard_cover;

    
SELECT STDDEV_POP(number_of_pages), STDDEV_SAMP(number_of_pages)
FROM
    books;
    
SELECT ROUND(STDDEV_POP(number_of_pages),3), ROUND(STDDEV_SAMP(number_of_pages),3)
FROM
    books;
    
SELECT 
    VAR_POP(number_of_pages), VAR_SAMP(number_of_pages)
FROM
    books;

# obliczamy współczynnik zmienności
SELECT 
    STDDEV_POP(number_of_pages)/AVG(number_of_pages) AS "współczynnik zmienności"
FROM
    books;
    
SELECT 
    STDDEV_POP(number_of_pages), power(VAR_POP(number_of_pages), 0.5)
FROM
    books;

-- które wydawnictwo wydaje najgrubsze książki? 
SELECT 
    publishing_house,
    AVG(number_of_pages)
FROM
    books
GROUP BY publishing_house
ORDER BY AVG(number_of_pages) DESC;
